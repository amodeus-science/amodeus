...
import amodeus.amodeus.view.jmapviewer.OsmMercator;
import amodeus.amodeus.view.jmapviewer.TileXY;
...
class ScanexTileSource extends TMSTileSource {
    ...
    public ScanexTileSource(TileSourceInfo info) {
        ...
        templateSource = new TemplatedTMSTileSource(info);
    }
    ...
    public String getTileUrl(int zoom, int tilex, int tiley) {
        if (templateSource != null)
            return templateSource.getTileUrl(zoom, tilex, tiley);
    ...
    public String getTilePath(int zoom, int tilex, int tiley) {
        ...
        return layer.getUri() + "&apikey=" + API_KEY + "&x=" + tilex + "&y=" + tiley + "&z=" + zoom;
    }
