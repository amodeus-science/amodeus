...
import amodeus.amodeus.view.jmapviewer.interfaces.TileJob;
import amodeus.amodeus.view.jmapviewer.interfaces.TileLoader;
import amodeus.amodeus.view.jmapviewer.interfaces.TileLoaderListener;
    ...
    private final class OsmTileJob implements TileJob {
        ...
        public void run() {
            ...
            try {
                ...
                if (input == null) {
                    try {
                        System.err.println("Failed loading " + tile.getUrl() + ": " + e.getClass() + ": " + e.getMessage());
