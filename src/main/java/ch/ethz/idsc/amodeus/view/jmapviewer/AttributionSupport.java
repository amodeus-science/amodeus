...
import static ch.ethz.idsc.amodeus.view.jmapviewer.FeatureAdapter.tr;
...
import ch.ethz.idsc.amodeus.view.jmapviewer.interfaces.Attributed;
    ...
    public void initialize(Attributed source) {
        ...
        if (requireAttr) {
            ...
            if (attrTermsUrl != null && attrTermsText == null) {
                // removed: "Background Terms of Use"
                attrTermsText = tr(" ");
            }
        } else {
            attrImage = null;
