...
/* package */ enum StaticHelper {
    ;
    /** distances zero */
    public static final Tensor ZEROS = Tensors.of(Quantity.of(0, SI.METER), Quantity.of(0, SI.METER)).unmodifiable();

    /** check that score monotonously increasing with respect to time */
    public static void requirePositiveOrZero(Tensor scoreAdd) {
