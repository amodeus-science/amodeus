...
public class AdaptiveRealTimeRebalancingPolicyTemp extends PartitionedDispatcher {
    ...
    public AdaptiveRealTimeRebalancingPolicyTemp( //
...
//                    getAVRequests(), distanceFunction, network, false);
    ...
    public static class Factory implements AVDispatcherFactory {
        ...
        public AVDispatcher createDispatcher(AVDispatcherConfig avconfig) {
            ...
            return new AdaptiveRealTimeRebalancingPolicyTemp(config, avconfig, generatorConfig, travelTime, router, eventsManager, network, virtualNetwork, abstractVirtualNodeDest,
