...
/* package */ final class SharedGeneralDriveDirective extends FuturePathDirective {
    ...
    final SharedAVMenu avMenu;

    public SharedGeneralDriveDirective(SharedRoboTaxi robotaxi, AVRequest avRequest, //
