package ch.ethz.idsc.amodeus.analysis.parking;
...
import ch.ethz.idsc.amodeus.analysis.parking.SaveUtils;
import ch.ethz.idsc.amodeus.analysis.parking.StaticHelper;
...
public class NumberPassengerParkingColorScheme implements AnalysisExport {
    //INSTANCE;
