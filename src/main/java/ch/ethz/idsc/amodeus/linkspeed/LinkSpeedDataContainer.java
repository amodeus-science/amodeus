...
public class LinkSpeedDataContainer implements Serializable {
    ...
    private final SortedMap<String, LinkSpeedTimeSeries> linkSet = new TreeMap<>();

    /** add a speed recording for @param link at @param time with a speed value [m/s] @param speed */
    public void addData(String link, int time, double speed) {
    ...
    public SortedMap<String, LinkSpeedTimeSeries> getLinkSet() {
