...
public enum TravelDataCreator {
    ...
    public static TravelData create(VirtualNetwork<Link> virtualNetwork, Network network, Population population, ScenarioOptions scenarioOptions, int numberOfVehicles) throws Exception {
