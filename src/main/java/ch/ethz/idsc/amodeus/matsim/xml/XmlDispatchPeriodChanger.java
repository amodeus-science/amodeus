...
public enum XmlDispatchPeriodChanger {
    ...
    public static void of(File simFolder, int dispatch) throws Exception {
        System.out.println("changing dispatch period to " + dispatch);
        ...
        try (XmlModifier xmlModifier = new XmlModifier(xmlFile)) {
            ...
            for (Element element : children) {
                ...
                if (theAttributes.get(0).getValue().equals("dispatchPeriod"))
                    theAttributes.get(1).setValue(Integer.toString(dispatch));
            }
