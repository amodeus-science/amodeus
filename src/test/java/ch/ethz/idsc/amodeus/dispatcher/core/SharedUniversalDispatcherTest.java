...
public class SharedUniversalDispatcherTest extends TestCase {
    public void testSimple() {
        ...
        SharedUniversalDispatcher dispatcher = new SharedUniversalDispatcher(config, avDispatcherConfig, travelTime, parallelLeastCostPathCalculator, eventsManager, db) {
