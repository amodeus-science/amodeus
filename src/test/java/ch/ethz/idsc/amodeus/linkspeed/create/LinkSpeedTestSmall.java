...
/* package */ class LinkSpeedTestSmall {
    ...
    public void trafficFlowChangeTest() throws Exception {
        for (TrafficDelayEstimate calculator : calculators) {
            ...
            Tensor difference = trafficFlowChange.subtract(Tensors.fromString("{{0.1499999999999999}, {0.14999999999999997},"//
    ...
    public void trafficFlowAbsTest() throws Exception {
        for (TrafficDelayEstimate calculator : calculators) {
            ...
            LSQTrafficEstimation estimator = //
                    LSQTrafficEstimation.of(flowMat, travelTimeFree, travelTimeMeasure, calculator);
            ...
            if (!(calculator instanceof GLPKLinOptDelayCalculator)) {
                ...
                Assert.assertTrue(estimator.error.equals(RealScalar.ZERO));
            }
        }
    }
