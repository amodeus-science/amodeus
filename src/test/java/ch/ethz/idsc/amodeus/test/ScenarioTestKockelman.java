...
//
//public class ScenarioTestKockelman {
//
...
//
//        /** HERE WE CHANGE THE DISPATCHER*/
//        XmlDispatcherChanger.of(workingDirectory, "DynamicRideSharingStrategy");
//
...
//
//        scalarAssert.add(RealScalar.of(177121.0/2160000.0), occupancyRatio);
//        scalarAssert.add(RealScalar.of(0.6063078960957484), distanceRatio);
//
//        /** fleet distances */
...
//        == ate.getDistancElement().totalDistance);
//
//        scalarAssert.add(RealScalar.of(44248.410552086774), RealScalar.of(ate.getDistancElement().totalDistance));
//        scalarAssert.add(RealScalar.of(28527.559221644126), RealScalar.of(ate.getDistancElement().totalDistanceWtCst));
//        scalarAssert.add(RealScalar.of(5139.464136413478), RealScalar.of(ate.getDistancElement().totalDistancePicku));
//        scalarAssert.add(RealScalar.of(10581.387194029063), RealScalar.of(ate.getDistancElement().totalDistanceRebal));
//
//        scalarAssert.add(RealScalar.of(0.644713761821186), RealScalar.of(ate.getDistancElement().totalDistanceRatio));
//
...
//
//        scalarAssert.add(Quantity.of(256.535, SI.SECOND), ate.getTravelTimeAnalysis().getWaitAggrgte().Get(1));
//        scalarAssert.add(Quantity.of(1993.0, SI.SECOND), ate.getTravelTimeAnalysis().getWaitAggrgte().Get(2));
//        scalarAssert.add(Quantity.of(89671.0/100.0, SI.SECOND), ate.getTravelTimeAnalysis().getDrveAggrgte().Get(1));
//        scalarAssert.add(Quantity.of(3820.0, SI.SECOND), ate.getTravelTimeAnalysis().getDrveAggrgte().Get(2));
//
